    ...
    function validate() 
   	{
		...
		if(uid.length<5 || uid.length>10)
		{
			...
			document.getElementById("uiderror").innerHTML = "UID length should be 8-15 characters";
                ...
                <div class="container background-white">
                    <div class="container">
                        <div class="row margin-vert-30">
                   			<center><font color="red" size="5"><i>Blood Bank Login</i></font></center><br/>
                            <!-- Login Box -->
                            <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            
                                <form class="login-page" action="Blood_Bank_Login_Val.jsp" method="post" name="form" >
                                    ...
                                    <div class="input-group margin-bottom-20">
                                        ...
                                        <input placeholder="Username" class="form-control" type="text" name="uid" onblur="check()" required>
