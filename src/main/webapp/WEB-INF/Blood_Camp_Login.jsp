...
<!-- Title -->
   ...
   <script type="text/javascript">
   	function validate() 
   	{
   		var uid=doucument.form.uid.value;
            ...
            <div id="content">
                <div class="container background-white">
                   ...
                   <div class="container">
                        ...
                        <marquee><h2><font color="red"><i>Blood Camp Login Page</i></font></h2></marquee>
                 
                            <!-- Login Box -->
                            <div class="container background-red">
                            <div class="col-xs-6 col-md-offset-3 col-sm-offset-3" >
                                <form class="login-page" action="Validate_Login.jsp" name="form" method="post">
                                    ...
                                    <div class="input-group margin-bottom-20">
                                        ...
                                        <input placeholder="Username" class="form-control" type="text" name="uid" required>
                                        
                                    </div>
                                    <div class="input-group margin-bottom-20">
                                        <span class="input-group-addon" id="pwd_error">
                                    ...
                                    <h4>Are you a new user?</h4>
                                     <p>
                                        <a href="Blood_Camp_Registration.html"><span style="color:red">Click here</span> </a>to register.</p>
                                </form>
                            </div>
                            </div>
                            <!-- End Login Box -->
