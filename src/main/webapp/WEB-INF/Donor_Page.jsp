                    ...
                    <div class="container">
                        <div class="row margin-vert-30">
                            ...
                            <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                                <div>
                                <ul>
                                	<h1><li><a href="Add_Donor.jsp">Donor Registration</a></li></h1>
                                	<h1><li><a href="Add_To_Repository.jsp">Add To Repository</a></li></h1>
                                	<h1><li><a href="Blood_Camp_Login.jsp">Logout</a></li></h1>
                                </ul>
                                </div>
                            </div>
                            <!-- End Login Box -->
