                        ...
                        %>
                          <h1>Welcome <%out.println(session.getAttribute("uid1")); %></h1>
                        	...
                        	<%
                        	  ...
                        	  <h2 style="color: maroon;">Payment Successfully Received by <%out.println(request.getParameter("mop")); %></h2>
                        	  
                        	  <h3 style="color: red;">Thank You for your order</h3>
                        	  
                        	  <h4 style="color: aqua;">Visit us again</h4>
