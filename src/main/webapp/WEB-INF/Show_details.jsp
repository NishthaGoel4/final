                    ...
                    <div class="container">
                        <div class="row margin-vert-30">
                            ...
                            <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                                ...
                                <ul>
                                	<h1><li><a href="Hospital_Details.jsp">Hospital Details </a></li></h1>
                                	<h1><li><a href="Blood_camp_Details.jsp">Blood_camp  Details</a></li></h1>
                                	<h1><li><a href="Blood_bank_Details.jsp">Blood_bank Details</a></li></h1>
                                	<h1><li><a href="Admin.jsp">Logout</a></li></h1>
                                </ul>
